...
@Component({
  selector: 'app-employeeattendancerecords',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './employeeattendancerecords.component.html',
  styleUrls: ['./employeeattendancerecords.component.scss'],
  providers: [DatePipe] // 只在此元件使用 DatePipe即可
})
export class EmployeeattendancerecordsComponent {
  // 目前指向的年月（0-11）
